...
class Organization(RemAi):
    ...
    def __init__(self, *xyears):
        ...
        arg = {
            ...
            "years": xyears,
            "year": xyears[0],
            "to_fpath": "exp-organization-" + datetime.now().strftime("%H%M") + ".xlsx",
            "map_db2t": {
    ...
    def __init__(self, year, coll=None):
        ...
        arg = {
            ...
            "map_fp2t": {
                ...
                "exam_number": {"source": "考生号", "format": "str"},
                "sname": {"source": "姓名", "format": "str"},  # d02
                "gender": {"source": "性别", "format": "str"},  # d03
                "birth_date": {"source": "出生日期", "format": "str"},
                "student_from_code": {"source": "生源地代码", "format": "str"},  # d04
                "student_from": {"source": "生源地名称", "format": "str"},  # d05
                "nationality": {"source": "民族名称", "format": "str"},
                "political status": {"source": "政治面貌", "format": "str"},
